...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "llm-operator.cogito.dev",
	})
	if err != nil {
	...
	if err = (&controller.LLMModelReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("llmmodel-controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LLMModel")
		os.Exit(1)
	}
	if err = (&controller.LLMModelOverlayReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LLMModelOverlay")
		os.Exit(1)
	}
